...
if($service == 'SLA'){
	include_once('cron/modules/SLA/SLA.service.php');
}
//crmv@22700
if($service == 'Newsletter'){
	include_once('cron/modules/Newsletter/Newsletter.service.php');
}
//crmv@22700e
//crmv@29617
if($service == 'ModNotifications'){
	include_once('cron/modules/ModNotifications/ModNotifications.service.php');
}
//crmv@29617e
//crmv@30007
if($service == 'SendReminder'){
	include_once('cron/modules/Calendar/SendReminder.service');
}
//crmv@30007e
//crmv@31126
if($service == 'ScheduledImport'){
	include_once('cron/modules/Import/ScheduledImport.service.php');
}
//crmv@31126e
?>