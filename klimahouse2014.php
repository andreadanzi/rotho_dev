...
$(function() {
	...
	var firstname = $( "#firstname" ),
		...
		privacy = $( "#privacy" ),
		country = $( "#country" ),
		allFields = $( [] ).add( firstname ).add( email ).add( lastname ).add( company ).add(phone).add(country).add( privacy ),
		tips = $( ".validateTips" );
	...
	.click(function(e) {
				...
				bValid = bValid && checkLength( country, "country", 2, 2 );
				...
				bValid = bValid && checkRegexp( country, /^[a-z]([a-z])+$/i, "Country deve essere composto solo dai caratteri a-z, e iniziare con una lettera." );
