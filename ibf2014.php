...
<!--  
danzi.tn@20140414 nuova form IBF 2014
-->
<style>
	body { font-size: 62.5%; }
...
$(function() {
	...
	.click(function(e) {
				...
				bValid = bValid && checkLength( firstname, "Vorname", 3, 16 );
				bValid = bValid && checkLength( lastname, "Nachname", 3, 16 );
				bValid = bValid && checkLength( company, "Unternehmen", 3, 25 );
				bValid = bValid && checkLength( phone, "Telefon", 3, 25 );
		...
		<div id="form-container">
			<div id="dialog-form" title="Registrati!">
				<form name="EASY" action="http://crm.rothoblaas.com/modules/Webforms/rotho.capture.php" method="post" accept-charset="utf-8">
					...
					<input type="hidden" id="rdrct"  name="rdrct" value="ibf2014"></input>
					<input type="hidden" value="14 IBF_CZ" name="leadsource"></input>
					<table width="800px">
					<tbody>
						<tr VALIGN=TOP>
							<td>
