...
if(isset($forfield) && $forfield != '' && $focus->popup_type != 'detailview') {
	...
	$autocomplete_return_function[$entity_id] = "return_category_to_nonconformity($entity_id, \"$value\", \"$forfield\", \"$product_description\", \"$product_category\", \"$vendor_id\", \"$vendor_descr\", \"$purchase_user_id\", \"$purchase_user_id_display\");";
