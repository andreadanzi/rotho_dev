...
if(isset($forfield) && $forfield != '' && $focus->popup_type != 'detailview') {
	...
	$link_from_other = '';
	// danzi.tn@20141212
	$query = "SELECT ".$table_prefix."_account.account_client_type AS category FROM ".$table_prefix."_account 
             JOIN ".$table_prefix."_crmentity ON ".$table_prefix."_account.accountid = ".$table_prefix."_crmentity.crmid  
             
             WHERE ".$table_prefix."_crmentity.deleted = 0 AND ".$table_prefix."_account.accountid = ".$entity_id;
