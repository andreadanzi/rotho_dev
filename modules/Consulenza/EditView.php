...
//mycrmv@24524
if ($focus->column_fields['parent'] != '' && $focus->column_fields['parent'] != 0) {
	$smowner=getUserId($focus->column_fields['parent']);
	$focus->column_fields['agente_riferimento'] = $smowner;
	$capoarea_test=crmv_capoarea2($focus->column_fields['parent'],fetchUserRole($smowner));
	if ($capoarea_test == '' && $capoarea_test == null){
	$capoarea_test=1;
	}
	$focus->column_fields['capoarea'] = $capoarea_test;
	$categoria=crmv_categoria($entity_id);
	if ($focus->column_fields['consulenzacetegory'] == '') {
		$focus->column_fields['consulenzacetegory'] = $categoria;
		}
	}
	//mycrmv@24524
