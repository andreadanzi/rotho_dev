...
class Marketprices extends CRMEntity {
	...
	var $table_name;
	var $table_index= 'marketpricesid';
	...
	function __construct() {
		...
		$this->table_name = $table_prefix.'_marketprices';
		$this->customFieldTable = Array($table_prefix.'_marketpricescf', 'marketpricesid');
		$this->entity_table = $table_prefix."_crmentity";
		$this->tab_name = Array($table_prefix.'_crmentity', $table_prefix.'_marketprices', $table_prefix.'_marketpricescf');
		$this->tab_name_index = Array(
			$table_prefix.'_crmentity' => 'crmid',
			$table_prefix.'_marketprices'   => 'marketpricesid',
			$table_prefix.'_marketpricescf' => 'marketpricesid'
		);
		$this->list_fields = Array(
			...
			'Subject' => Array($table_prefix.'_marketprices','marketprice_subject'),
...
//crmv@8398e	
		...
		return getHistory('Marketprices',$query,$id);
	}
	/** 
