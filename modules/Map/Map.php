...
class Map extends CRMEntity {
    ...
    /**
     * Undocumented object field for CRMEntity::get_dependents_list and CRMEntity::get_related_list
     * Format is: LEFT JOIN vtiger_T1 ON vtiger_T1.C1 = vtiger_T2.C2
     * C1 is mandatory. Default for vtiger_T2 is this:table_name. Default for C2 is C1.
     */
    //var $related_tables = Array ( 'vtiger_T1'=>Array('C1', 'vtiger_T2', 'C2'), );
    ...
    var $list_fields = Array (
        /* Format: Field Label => Array(tablename, columnname)
           ...
           This data must conform to the data in the vtiger_field table!!!
           So check the vtlib creation script.
        */
        'LBLENTITANAME'=> Array('map', 'mapname'),
