...
function getDescription(id, pos, name, type, map_value, city, extra, map_aurea)
{
	var html = "";
	switch(module)
	{
...
function createArrays() {
	for (var j in resultLayer) 
	{
		...
		var contentString = getDescription(j, pos ,result["name"] ,result["type"] ,result["map_value"],result["city"],result["extra"],result["map_aurea"]);
