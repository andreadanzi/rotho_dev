...
// include_once 'plugins/erpconnector/AccRating_populate/new/AccRatingClass.php';
...
class AccountsHandler extends VTEventHandler {
	...
	function handleEvent($eventName, $data) {
		...
		if($eventName == 'vtiger.entity.aftersave') {
			...
			$accRating->setVars($log_active,$ratingField, $codiceCorsoTargetField,$codiceCorsoCampagnaField, $codiceFatturazioneCorsoField,$codiceCategoriaField,$tipoAffiliazioneField,$map_corsi );
