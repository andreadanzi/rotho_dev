...
function showInMapListViewData(elem) {
	...
	*/
	...
	document.location.href = 'index.php?from=' + file_value + '&show=Accounts&viewid=' + viewId + userid_url +'&valueSel=' + valueSel + '&valueId='+valueId.val()+'&map_mindate='+proddate_start.val()+'&map_maxdate='+proddate_end.val()+'&type_or_value=type&cluster=Enable&module=Map&action=index&parenttab=Tools&amountrange=' + amount_value.val();;
}
