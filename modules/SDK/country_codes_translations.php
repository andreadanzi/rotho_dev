...
$modules_array = array('Accounts','Consulenza','Contacts','Invoice','Leads','PurchaseOrder','Quotes','SalesOrder','Users','Vendors');
foreach($modules_array as $mod) {
	foreach($temp_country_iso as $item) {
		SDK::setLanguageEntry( $mod,'it_it',$item['iso2'] , $item['italian'] );
		SDK::setLanguageEntry( $mod,'en_us', $item['iso2'] , $item['english']);
		SDK::setLanguageEntry( $mod,'ru_ru', $item['iso2'] , $item['english']);
		SDK::setLanguageEntry( $mod,'de_de', $item['iso2'] , $item['german']);
		SDK::setLanguageEntry( $mod,'es_es', $item['iso2'] , $item['spanish']);
		SDK::setLanguageEntry( $mod,'fr_fr', $item['iso2'] , $item['french']);
		SDK::setLanguageEntry( $mod,'pt_br', $item['iso2'] , $item['portuguese']);
	}
}
