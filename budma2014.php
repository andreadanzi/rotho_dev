...
<style>
	...
	div#main-container {background-image: url(budma2014.jpg);  width:1024px; height:768px }
		...
		<div id="form-container">
			<div id="dialog-form" title="Registrati!">
				<form name="EASY" action="http://crm.rothoblaas.com/modules/Webforms/rotho.capture.php" method="post" accept-charset="utf-8">
					...
					<input type="hidden" id="rdrct"  name="rdrct" value="budma2014"></input>
					<input type="hidden" value="14 FAIR BUDMA PL" name="leadsource"></input>
					<table width="800px">
					<tbody>
						<tr VALIGN=TOP>
							<td>
						...
						<tr>
							...
							<td>
								...
								<select class="select ui-widget-content ui-corner-all" id="assigned_user_id" name="assigned_user_id">
												...
												<option value="4411">Daniel Sokanski</option>
												<option value="112917">AM Daniel Sokanski PL</option>
												<option value="145">Grzegorz Wojtan</option>
												<option value="146">Michal Wolnik</option>
												<option value="157">Igor Rivny</option>
												<option value="26796">AM Igor Rivny RU</option>
							   </select>
							</td>
						</tr>
						<tr>
