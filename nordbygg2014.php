...
<style>
	...
	div#main-container {background-image: url(nordbygg2014.jpg);  width:1024px; height:768px }
		...
		<div id="form-container">
			<div id="dialog-form" title="Registrati!">
				<form name="EASY" action="http://crm.rothoblaas.com/modules/Webforms/rotho.capture.php" method="post" accept-charset="utf-8">
					...
					<input type="hidden" id="rdrct"  name="rdrct" value="nordbygg2014"></input>
					<input type="hidden" value="14 NORDBYGG_SE" name="leadsource"></input>
					<table width="800px">
					<tbody>
						<tr VALIGN=TOP>
							<td>
						...
						<tr>
							...
							<td>
								...
								<select class="select ui-widget-content ui-corner-all" id="assigned_user_id" name="assigned_user_id">
												...
												<option value="132910">AM Balla Diego SE-NO-FN-DK</option>
												<option value="125433">RM NORTH EUROPE Balla Diego</option>
												<option value="132973">Peter Viljo Koski</option>
												<option value="133005">Nilsen Peter</option>
												<option value="131320">DANIMARCA</option>
												<option value="103546">SWEDEN</option>
												<option value="103574">Janis Riekstins</option>	
												<option value="132880">AM Janis Riekstins EE-LT-LV</option>		
