...
class AccRatingClass {
	...
	private function _get_target_campaign_sql() {
		...
		$sql = "SELECT DISTINCT 
			...
			JOIN ".$table_prefix."_accountbillads on ".$table_prefix."_accountbillads.accountaddressid =  ".$table_prefix."_account.accountid AND ( ".$table_prefix."_accountbillads.bill_country like 'IT%' OR  ".$table_prefix."_accountbillads.bill_country like 'ES%' OR  ".$table_prefix."_accountbillads.bill_country like 'PT%' OR  ".$table_prefix."_accountbillads.bill_country like 'DE%' OR  ".$table_prefix."_accountbillads.bill_country like 'AT%' OR  ".$table_prefix."_accountbillads.bill_country like 'CH%' )
