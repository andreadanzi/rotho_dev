...
$records=populateMapTable(date("Y-m-d H:i:s",$time_start));
$time_end = time();
...
$res = Array(date("Y-m-d H:i:s",$time_end),$records['records_created'],($records['records_created']+$records['records_updated']),$duration_string,$working_id);
