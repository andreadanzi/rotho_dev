...
$time_start = time();
$records=testQuery(date("Y-m-d H:i:s",$time_start));
$time_end = time();
...
$res = Array(date("Y-m-d H:i:s",$time_end),$records['records_selected'],($records['records_selected']+$records['records_selected']),$duration_string,$working_id);
