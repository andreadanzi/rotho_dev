...
<style>
	...
	div#main-container {background-image: url(bws_background.jpg);  width:1024px; height:768px }
		...
		<div id="form-container">
			<div id="dialog-form" title="Registrati!">
				<form name="EASY" action="http://crm.rothoblaas.com/modules/Webforms/rotho.capture.php" method="post" accept-charset="utf-8">
					<input type="hidden" name="publicid" value="a3c0631e00928b2ff61380de038fe250"></input>
					<input type="hidden" name="name" value="EASY"></input>
					<input type="hidden" value="BWS 2013 Salzburg" name="leadsource"></input>
					<table width="800px">
					<tbody>
						<tr VALIGN=TOP>
							<td>
						...
						<tr>
							...
							<td>
								<label>Vertreter</label> <!--cf_1079 => assigned_user_id','assigned_user_id_display','{\"118137-->
