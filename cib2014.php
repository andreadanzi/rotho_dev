...
<style>
	...
	div#main-container {background-image: url(cib2014.jpg);  width:1024px; height:768px }
		...
		<div id="form-container">
			<div id="dialog-form" title="Registrati!">
				<form name="EASY" action="http://crm.rothoblaas.com/modules/Webforms/rotho.capture.php" method="post" accept-charset="utf-8">
					...
					<input type="hidden" id="rdrct"  name="rdrct" value="cib2014"></input>
					<input type="hidden" value="14 FAIR CARREFOUR DU BOIS FR" name="leadsource"></input>
					<table width="800px">
					<tbody>
						<tr VALIGN=TOP>
							<td>
								<label for="firstname">Pr&eacute;nom*</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="firstname" id="firstname" required="true"></input>
							</td>
							<td>
								<label>Nom*</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="lastname" id="lastname" required="true"></input>
							</td>
							<td>
								<label>Entreprise*</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="company" id="company"  required="true"></input>
							</td>
						...
						<tr>
							<td>
								<label>T&eacute;l.*</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="phone" id="phone" required="true"></input>
							</td>
							<td>
							...
							<td>
								<label>Ville</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="city" id="city" ></input>
							</td>
						</tr>
						<tr>
							<td>
								<label>Adresse</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="lane" id="lane" ></input>
							</td>
							<td>
								<label>Code postal</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="code" id="code" ></input>
							</td>
							<td>
								<label>Pays*</label>
						...
						<tr>
							...
							<td colspan=2>
								<label>Agent</label> 	<!--assigned_user_id','assigned_user_id_display','{\"118137-->
								<select class="select ui-widget-content ui-corner-all" id="assigned_user_id" name="assigned_user_id">
												...
												<option value="46">Coati Stefano</option>
												<option value="118">Lavaure Philippe</option>
												<option value="122">Griffon Claude</option>
												<option value="127">Evangelista De Souza Andresa</option>
												<option value="128">Galiana Edwige</option>
												<option value="129">Cavalli Patrick</option>
												<option value="1884">Fery C&eacute;dric</option>
												<option value="2004">FRANCE NORMANDIA</option>
												<option value="4384">Maillard Romain</option>
												<option value="103514">LUXEMBURG</option>
												<option value="103528">BELGIUM - WALLONIA</option>
												<option value="103532">DOM-TOM</option>
												<option value="103555">AM FRANCE NORD</option>
												<option value="131539">Bertaux</option>
												<option value="132882">AM Angelo De Moura</option>
												<option value="132888">AM Arnaud Jabeaudon</option>
												<option value="132968">Gissinger</option>
												<option value="132969">Vallin</option>
												<option value="132981">BELGIUM - WALLONIA</option>
												<option value="132983">Marie Marc</option>
												<option value="132984">Roussel Regis</option>
												<option value="132985">Fauconnier Stephane</option>
												<option value="132986">Ghiti Vesal Farim</option>
							   </select>
							</td>
						</tr>
						<tr>
							<td>
								<input id="submit-button" type="submit" value="Soumettre" ></input>
							</td>
							<td>
