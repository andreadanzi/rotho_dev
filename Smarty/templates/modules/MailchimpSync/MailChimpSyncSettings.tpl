...
<input type='hidden' name='module' value='MailchimpSync'>
<input type='hidden' name='action' value='MailchimpSyncSettings'>
<input type='hidden' name='parenttab' value='MailchimpSync'>
	...
	<div align=center>
			...
			<!-- DISPLAY -->
				<table border=0 cellspacing=0 cellpadding=5 width=100% class="settingsSelUITopLine">
					<tr>
						<td width=50 rowspan=2 valign=top><img src="{'custom.gif'|@vtiger_imageurl:$THEME}" alt="MailchimpSync Settings" width="48" height="48" border=0 title="MailchimpSync Settings"></td>
						<td class=heading2 valign=bottom><b><a href="index.php?module=Settings&action=index&parenttab=Settings">{$MOD.LBL_SETTINGS}</a> > MailchimpSync Settings</b></td>
					</tr>
					<tr>
...
<script type="text/javascript">
	...
	new Ajax.Request(
		...
		{queue: {position: 'end', scope: 'command'},
			method: 'post',
			postBody: 'module=MailchimpSync&action=MailchimpSyncAjax&file=SaveMailChimpId&apikey='+apikey+'&listid='+listid+'&parenttab=MailchimpSync&newsubscriber='+newsubscriber+'&ajax=true',
