						...
						<tr>
                            ...
                            <td width="70%" colspan=2>
								...
								<select name="rule_actiontext" class="small">
									...
									{*//mycrmv@3147*}
									<option value="CREATEUSR,HelpDesk,FROM" {if $RULEACTIONTEXT eq 'CREATEUSR,HelpDesk,FROM'}selected=true{/if}
									>{$MOD.LBL_CREATE} {$MOD.LBL_TICKET} ({'Users'|@getTranslatedString:'Users'})</option>
									{*//mycrmv@3147 e*}									
									{*//danzi.tn@20140207*}
