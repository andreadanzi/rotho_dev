	...
	<div align=center>
			...
			{include file='Buttons_List.tpl'} {* crmv@30683 *}
				...
				<tr>
					...
					<td class=heading2 valign=bottom><b>{$MOD.LBL_SETTINGS} > {$UMOD.LBL_EMAIL_TEMPLATES} </b></td>
				</tr>
				<tr>
				...
				<td>
					...
					<tr>
						...
						<!-- danzi.tn@20150210 aggiunto templatetype -->
						<td width="10%" class="colHeader small">{'LBL_TYPE'|getTranslatedString}</td>
						<!-- danzi.tn@20150210e -->
					...
					<tr>
						...
						<!-- danzi.tn@20150210 aggiunto templatetype -->
						<td class="listTableRow small" valign=top>{$template.templatetype}&nbsp;</td>
						<!-- danzi.tn@20150210e -->
					        <!--<td class="listTableRow small" valign=top>
