...
<style>
	...
	div#main-container {background-image: url(fiera_background.jpg);  width:1024px; height:768px }
...
$(function() {
	...
	.click(function(e) {
				...
				bValid = bValid && checkRegexp( firstname, /^[a-z]([0-9a-z_ ])+$/i, "Nome deve essere composto dai caratteri a-z, 0-9, _ (trattino basso), e iniziare con una lettera." );
				bValid = bValid && checkRegexp( lastname, /^[a-z]([0-9a-z_ ])+$/i, "Cognome deve essere composto dai caratteri a-z, 0-9, _ (trattino basso), e iniziare con una lettera." );
				bValid = bValid && checkRegexp( company, /^[a-z]([0-9a-z_ ])+$/i, "Azienda deve essere composto dai caratteri a-z, 0-9, _ (trattino basso), e iniziare con una lettera." );
	...
	{
		$( "#picture_dialog" ).prepend('<h3>Registrazione Avvenuta con Successo</h3><p>Il contatto &egrave; disponibile sul Client+</p>');
	...
	<div id="main-container">
		<div id="form-container">
			<div id="dialog-form" title="Registrati!">
				<form name="EASY" action="http://crm.rothoblaas.com/modules/Webforms/capture.php" method="post" accept-charset="utf-8">
					<input type="hidden" name="publicid" value="824a079a2c9ba8c2ef73181d66e3bca8"></input>
					<input type="hidden" name="name" value="EASY"></input>
					<input type="hidden" value="Fiera Legno e Edilizia Verona 2013" name="leadsource"></input>
					<table width="800px">
					<tbody>
						<tr VALIGN=TOP>
							<td>
								<label for="firstname">Nome*</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="firstname" id="firstname" required="true"></input>
							</td>
							<td>
								<label>Cognome*</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="lastname" id="lastname" required="true"></input>
							</td>
							<td>
						...
						<tr>
							<td>
								<label>Telefono*</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="phone" id="phone" required="true"></input>
							</td>
							<td>
							...
							<td>
								<label>Citta`</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="city" id="city" ></input>
							</td>
						</tr>
						<tr>
							<td>
								<label>Via</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="lane" id="lane" ></input>
							</td>
							<td>
								<label>CAP</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="code" id="code" ></input>
							</td>
							<td>
								<label>Stato</label><input type="text"  class="text ui-widget-content ui-corner-all" value="" name="country"  id="country" ></input>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td colspan=2>
								<p class="validateTips">*Campi obbligatori.</p>
							</td>
							<td align="right">
