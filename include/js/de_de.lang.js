...
var alert_arr = {       
	...
	LBL_MANDATORY_FIELDS_WF: 'Füllen Sie bitte die Pflichtfelder aus',
	LBL_DELETE_MSG: 'Sind Sie sicher',
	LBL_DUPLICATE_NAME: 'Webformular bereits vorhanden',
	ERR_SELECT_EITHER: 'Wählen Sie entweder die Organisation oder den Kontakt zur Leadsumwandlung',
	ERR_SELECT_ACCOUNT: 'Wählen Sie bitte die Firma aus um fortzufahren',
	ERR_SELECT_CONTACT: 'Wählen Sie Ihren Kontakt um fortzufahren',
	ERR_MANDATORY_FIELD_VALUE: 'Einige Pflichtfelder fehlen noch,, bitte füllen Sie diese aus',
	ERR_POTENTIAL_AMOUNT: 'Der Gesamtbetrag ist nicht gültig ',
	ERR_EMAILID: 'Geben Sie bitte eine gültige E-Mail ein',
	ERR_TRANSFER_TO_ACC: 'Organisation',
	ERR_TRANSFER_TO_CON: 'Kontakt auswählen zur Übertragung der verbundenen Datensätze',
	SURE_TO_DELETE_CUSTOM_MAP: 'Sind Sie sicher,, das Mapping löschen wollen?',
	LBL_CLOSE_DATE: 'Schlißdatum',
	LBL_EMAIL: 'E-Mail',
	MORE_THAN_500: 'Sie haben mehr als 500 Datensätze ausgewählt. Diese Operation könnte lange andauern. Möchten Sie fortfahren?',
	LBL_MAPPEDALERT: 'Das Feld wurde schon zugeordnet. ',
	LBL_SELECT_DEL_FOLDER: 'Mindestens einen Ordner auswählen',
	LBL_NO_EMPTY_FOLDERS: 'Es gibt keine leere Ordner',
	LBL_OR: 'oder'
};
